            ...
            if (id == "ID") {
                ...
                if (!gathered) {
                    if (restOfLine.size == 10) {
                        ...
                        currentIperf3RunningState.timeout = restOfLine[6]
                        val localHostPort =  "$currentIperf3RunningState.localHost:$currentIperf3RunningState.localPort"
                        val remoteHostPort = "$currentIperf3RunningState.remoteHost:$currentIperf3RunningState.remotePort"
                            ...
                            when (sendOrReceive.lowercase()) {
                                ...
                                "sender", "receiver" -> {
                                    ...
                                    if (!finished) {
                                        ...
                                        currentIperf3RunningState.rawAverage = "$bitRateString $bitRateUnitString"
                                    ...
                                    if (lastOmitted) currentIperf3RunningState.intervalNumber = 0
                                    lastOmitted = false
                                    ...
                                    if (currentIperf3RunningState.stalled) {
                                        ...
                                        timeLabel =if (!isSingleThread) "$currentIperf3RunningState.parallelStreams streams" else "Running"
...
fun getSampleSize(iperf3RunningState: Iperf3RunningState): String {
    ...
    if (iperf3RunningState.totalSamples > 0) {
        res = "Samples: ${iperf3RunningState.totalSamples} [${iperf3RunningState.totalOmitted} omitted]"
            //Locale.US,
        ...
        if (iperf3RunningState.totalStalled > 0) {
            res += "  {$iperf3RunningState.totalStalled stalled}"
        }
    }
    return res
}
...
fun printLineResult(iperf3RunningState: Iperf3RunningState): String {
    ...
    out.append("       Raw Average: ${iperf3RunningState.rawAverage}\n")
